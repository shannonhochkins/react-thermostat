...
import $4MPRY$emotionstyledbase from "@emotion/styled/base";
...
function $ad8779185d5cf574$export$38a233b5ad2f3b00({ size: size , mask: mask = null , ticks: ticks = $ad8779185d5cf574$var$TICK_DEFAULTS  }) {
    ...
    return /*#__PURE__*/ (0, $4MPRY$jsx)("g", {
        ...
        children: Array(count).fill(undefined).map((u, i)=>{
            ...
            return /*#__PURE__*/ (0, $4MPRY$jsx)("line", {
                stroke: color,
...
const $0250fd3e5e408b4c$var$HandleBase = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("circle", {
    target: "e1pg1usi1"
})("");
const $0250fd3e5e408b4c$var$HandlePulse = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("circle", {
    target: "e1pg1usi0"
})({
    name: "1r30l47",
...
function $0250fd3e5e408b4c$export$94890c79f4cae6d6({ x: x = 0 , y: y = 0 , size: size = 30 , handleSize: handleSize = 8 , colors: colors = $0250fd3e5e408b4c$export$78486ed8e1ee431c  }) {
    ...
    const ref = (0, $4MPRY$useRef)(null);
    const svgRef = (0, $4MPRY$useRef)(null);
    const [angle, setAngle] = (0, $4MPRY$useState)(0);
    ...
    return /*#__PURE__*/ (0, $4MPRY$jsxs)("svg", {
        ...
        children: [
            /*#__PURE__*/ (0, $4MPRY$jsx)($0250fd3e5e408b4c$var$HandlePulse, {
                r: handleSize,
                cx: x,
                cy: y,
                fill: _colors.pulse,
            ...
            /*#__PURE__*/ (0, $4MPRY$jsx)($0250fd3e5e408b4c$var$HandleBase, {
                r: handleSize,
                cx: x,
                cy: y,
                fill: _colors.handle
...
const $090815f5086f7f29$var$Wrapper = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("div", {
    target: "e1wqv6dx5"
})({
    name: "bjn8wh",
    styles: "position:relative"
});
const $090815f5086f7f29$var$ColorPicker = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("canvas", {
    target: "e1wqv6dx4"
})({
    name: "ugxobr",
    styles: "position:absolute;z-index:-1;visibility:hidden"
});
const $090815f5086f7f29$var$HandleContainer = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("div", {
    target: "e1wqv6dx3"
...
const $090815f5086f7f29$var$Thermometer = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)((0, $9bef96d565fcefc2$export$a72d32054f236c4), {
    target: "e1wqv6dx2"
})("color:", (props)=>props.color, ';font-family:"Kanit",sans-serif;font-weight:100;');
const $090815f5086f7f29$var$Gradient = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("div", {
    target: "e1wqv6dx1"
})("width:", (props)=>props.width, "px;height:", (props)=>props.height, "px;");
const $090815f5086f7f29$var$Arc = /*#__PURE__*/ (0, $4MPRY$emotionstyledbase)("svg", {
    target: "e1wqv6dx0"
})({
    name: "bjn8wh",
    styles: "position:relative"
...
function $090815f5086f7f29$export$c1cbc01833f43ebe({ size: size = 200 , min: min = 0 , max: max = 100 , value: value , valueSuffix: valueSuffix , handle: handleInput , track: trackInput , onChange: onChange , disabled: disabled  }) {
    ...
    const _svgRef = (0, $4MPRY$useRef)(null);
    const _handleRef = (0, $4MPRY$useRef)(null);
    const _canvasRef = (0, $4MPRY$useRef)(null);
    const [color, setColor] = (0, $4MPRY$useState)("transparent");
    ...
    return /*#__PURE__*/ (0, $4MPRY$jsxs)($090815f5086f7f29$var$Wrapper, {
        children: [
            /*#__PURE__*/ (0, $4MPRY$jsx)($090815f5086f7f29$var$ColorPicker, {
                width: (0, $234747a9630b4642$export$2c9a6d1027132519),
                height: (0, $234747a9630b4642$export$aeb116877fd5ad06),
                ref: _canvasRef
            }),
            /*#__PURE__*/ (0, $4MPRY$jsxs)($090815f5086f7f29$var$Arc, {
                width: size,
                height: height,
                ref: _svgRef,
                children: [
                    /*#__PURE__*/ (0, $4MPRY$jsx)($090815f5086f7f29$var$Thermometer, {
                    ...
                    /*#__PURE__*/ (0, $4MPRY$jsxs)("svg", {
                        width: size,
                        height: size,
                        y: height - size,
                        children: [
                            /*#__PURE__*/ (0, $4MPRY$jsx)("foreignObject", {
                                x: 0,
                                y: 0,
                                width: size,
                                height: size,
                                clipPath: "url(#clip)",
                                children: /*#__PURE__*/ (0, $4MPRY$jsx)($090815f5086f7f29$var$Gradient, {
                                    width: size,
                                    height: size,
                                    style: {
                            ...
                            /*#__PURE__*/ (0, $4MPRY$jsx)("mask", {
                                id: "arc-mask",
                                children: /*#__PURE__*/ (0, $4MPRY$jsx)("path", {
                                    d: arc,
                                    fill: "white"
                                })
                            }),
                            /*#__PURE__*/ (0, $4MPRY$jsx)("clipPath", {
                                id: "clip",
                                children: /*#__PURE__*/ (0, $4MPRY$jsx)("path", {
                                    d: arc
                                })
                            }),
                            track.markers.enabled && /*#__PURE__*/ (0, $4MPRY$jsx)((0, $ad8779185d5cf574$export$38a233b5ad2f3b00), {
                                ticks: {
            ...
            !disabled && /*#__PURE__*/ (0, $4MPRY$jsx)($090815f5086f7f29$var$HandleContainer, {
                ...
                children: /*#__PURE__*/ (0, $4MPRY$jsx)((0, $0250fd3e5e408b4c$export$94890c79f4cae6d6), {
